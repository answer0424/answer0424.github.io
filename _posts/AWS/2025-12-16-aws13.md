...
- Amazon ECR ➡️ 컨테이너 이미지 저장 및 배포
- Amazon ECS/EKS ➡️ 컨테이너 오케스트레이션 및 실행
- AWS App2Container ➡️ 온프레미스/클라우드 애플리케이션의 컨테이너 전화 지원
- Red Hat OpenShift on AWS ➡️ OpenShift 기반 컨테이너 운영 환경 제공