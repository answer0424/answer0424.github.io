...
> 물리적 시스템의 디지털 트윈을 생성하는 서비스

- 여러 데이터 소스를 통합하여 현실 세계의 가상 표현을 만들고, 이를 통해 작업 최적화 및 성능 개선을 도울 수 있음

<br>

#### AWS 파트너 디바이스 카탈로그

> AWS와 호환되는 IoT 하드웨어 및 디바이스 목록을 제공하는 카탈로그

- 개발 키드, 센서, 게이트웨이 등 다양한 하드웨어를 탐색하여 IoT 프로젝트 구축/출시를 용이하게 함

<br>

#### FreeRTOS

> 마이크로컨트롤러용 경량 오픈 소스 운영체제

- 소형 저전력 엣지 디바이스가 AWS IoT Core 또는 Greengrass 등과 안전하게 연결/관리되도록 지원함

<hr>

## 정리

- 연결 및 통신: AWS IoT Core
- 보안/관제: Device Defender, Device Management
- 데이터 처리/분석: IoT Analytics, IoT Events
- 엣지 및 차량 IoT: Greengrass, FleetWise
- 산업 데이터/디지털 트윈: SiteWise, TwinMaker
- 개발/하드웨어 지원: ExpressLink, Partner Device Catalog, FreeRTOS
- IoT 트리거 장치: IoT Button