...
- 무 VPN 방식으로 보안 기반 애플리케이션 액세스를 제공
- Zero Trust 원칙을 기반으로 실시간 엑세스 평가를 수행

<br>

#### Amazon VPC

- 사용자 정의 가상 네트워크 환경을 프로비저닝하고 제어할 수 있음
- IP 주소 범위, 서브넷, 라우트 테이블, 게이트웨이 등을 구성하여 네트워크를 디자인할 수 있음

<br>

#### Amazon VPC Lattice

- 서비스 간 연결 및 통신 정책/모니터링을 단순화하는 완전관리형 네트워크 서비스를 제공

<br>

#### Site-to-Site VPN

- 온프레미스 네트워크와 AWS 네트워크 간 암호화된 VPN 터널을 생성하여 안전한 통신을 제공
- AWS Site-to-Site VPN 과 AWS Client VPN이 포함됨