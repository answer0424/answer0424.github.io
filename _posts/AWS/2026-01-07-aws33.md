...
- CloudFormation, Terraform, CDK, 스크립트 등 자동화 환경에서 AMI ID를 고정하지 않고도 최신 이미지로 배포할 수 있음
- 예를 들어, Launch Template이나 Auto Scaling 설정에 `resolve:ssm:` 경로를 넣어두면 AMI 수동 관리 부담이 줄어듦