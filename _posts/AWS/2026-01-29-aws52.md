...
> PowerShell에서도 `-WithCooldown` 옵션을 통해 24시간 휴지 기간을 적용할 수 있음
...
| 항목 | 설명 |
|-|-|
| 기능 | AMI의 우발적/악의적 삭제 차단 |
| 기본값 | 비활성화 |
| 핵심 동작 | 활성화 시 AMI 등록 취수 불가 |
| 24시간 휴지 옵션 | 보호 해제 후 24시간 동안 여전히 보호 |
| 설정 방식 | 콘솔, CLI, PowerShell | 