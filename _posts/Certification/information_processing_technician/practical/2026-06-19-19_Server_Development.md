...
| 과정 | 내용 |
|-|-|
| DTO/VO 구현 | 데이터 교환을 위해 사용할 객체를 만드는 과정 <br> 송수신할 데이터의 자료형에 맞는 변수 및 객체를 생성 |
| SQL 구현 | 데이터 삽입, 변경, 삭제 등의 작업을 수행할 SQL문을 생성하는 과정 <br> SQL문은 소스 코드 내에 직접 입력, 또는 별도의 XML 파일로 관리함 |
