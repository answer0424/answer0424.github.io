...
```java
// src/test/java/com/example/MyServiceIntegrationTest.java
...
@ContextConfiguration(locations = { "/applicationContext.xml", "/test-datasource.xml" })
public class MyServiceIntegrationTest {
    ...
    void testServiceLogic() {
        // given: test-datasource.xml 등에서 테스트용 DataSource/DB 설정을 함께 로드

        // when
        String result = myService.processSomething(...);
