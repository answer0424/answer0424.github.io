...
## 간단한 예제: Controller + 서비스 포함한 Web Mock 테스트
...
@ExtendWith(SpringExtension.class)
@WebAppConfiguration
@ContextConfiguration(classes = { WebConfig.class, HelloController.class })
...
- Web Mocks는 Spring MVC / Web 계층 테스트를 가볍고 빠르게 할 수 있게 해주는 가짜 서블릿 환경 + mock 요청 / 응답 객체 + WebApplicationContext + MockMvc 지원 기능
- 실제 컨테이너 대신 mock servlet environment 사용 ➡️ 빠른 테스트 + MVC 흐름 검증 가능
- 단 한계도 있음 - 실제 WAS-specific 기능, 네트워크 / servlet container 종속 기능, 또는 설정 누락 / 불일치 등에 유의해야 함