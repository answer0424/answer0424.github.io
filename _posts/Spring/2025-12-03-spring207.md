...
> Context Caching은 Spring 테스트에서 비싼 ApplicationContext 로딩을 한 번만 하고, 여러 테스트에서 재사용하도록 해주는 핵심 최적화 메커니즘임
>
> 올바르게 사용하면 테스트 속도를 크게 줄이고, 개발 생산성을 높을 수 있지만 설정 변경, mock/spy 사용, mutable 상태, 리소스 공유 등에는 주의해야 함